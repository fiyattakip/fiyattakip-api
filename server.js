...
app.post("/api/kamera-ai", async (req, res) => {
  ...
  try {
    ...
    const prompt = "Bu fotoğraftaki ürünü detaylı şekilde tanımla. Ürün adı, marka, model, renk ve özelliklerini belirt. Türkçe cevap ver. Sadece ürün bilgilerini listele.";
...
app.listen(PORT, () => console.log("FiyatTakip API çalışıyor, Port:", PORT));
